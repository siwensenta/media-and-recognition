...
class TransformerModel(nn.Module):
    def __init__(self, 
        ...
        self.encoder_layer = nn.TransformerEncoderLayer(d_model, n_head, dim_feedforward)
        self.encoder = nn.TransformerEncoder(self.encoder_layer, num_encoder_layers)
        self.decoder_layer = nn.TransformerDecoderLayer(d_model, n_head, dim_feedforward)
