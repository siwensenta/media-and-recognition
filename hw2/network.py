...
class Linear(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.W = nn.Parameter(torch.randn(output_size, input_size), requires_grad=True)
...
class MLP(nn.Module):
    def __init__(self, input_size, output_size, hidden_size, n_layers, act_type):
        ...
        # TODO 4: Finish MLP with at least 2 layers
            ...
            input_layer = Linear(input_size, hidden_size[0])
            ...
            for i in range(1, n_layers - 1):
                ...
                hidden_layer = Linear(hidden_size[i-1], hidden_size[i])
            ...
            output_layer = Linear(hidden_size[-1], output_size)
